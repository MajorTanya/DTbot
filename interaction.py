...
class Interaction(commands.Cog):
    ...
    async def baka(self, interaction: discord.Interaction, user: discord.Member):
        ...
        embed = make_embed(interaction.user.id, baka_links, target=user, self_tag_msg=self_msg, other_tag_msg=other_msg,
    ...
    async def blush(self, interaction: discord.Interaction, reason: str | None):
        ...
        embed = make_embed(interaction.user.id, blush_links, target=interaction.user, self_tag_msg=msg)
        await interaction.response.send_message(embed=embed)
    ...
    async def boop(self, interaction: discord.Interaction, user: discord.Member):
        ...
        embed = make_embed(interaction.user.id, boop_links, target=user, self_tag_msg=self_msg, other_tag_msg=other_msg,
                           img_on_self_tag=False)
        await interaction.response.send_message(embed=embed)
    ...
    async def cry(self, interaction: discord.Interaction, reason: str | None):
        ...
        embed = make_embed(interaction.user.id, cry_links, target=None, no_tag_msg=msg)
        await interaction.response.send_message(embed=embed)
    ...
    async def cuddle(self, interaction: discord.Interaction, user: discord.Member):
        embed = make_embed(interaction.user.id, cuddle_links, target=user,
    ...
    async def handholding(self, interaction: discord.Interaction, user: discord.Member):
        ...
        embed = make_embed(interaction.user.id, handholding_links, target=user, self_tag_msg=self_msg,
    ...
    async def hide(self, interaction: discord.Interaction, reason: str | None):
        ...
        embed = make_embed(interaction.user.id, hide_links, target=interaction.user, self_tag_msg=msg)
        await interaction.response.send_message(embed=embed)
    ...
    async def highfive(self, interaction: discord.Interaction, user: discord.Member):
        ...
        embed = make_embed(interaction.user.id, highfive_links, target=user, self_tag_msg=self_msg,
                           other_tag_msg=other_msg)
        await interaction.response.send_message(embed=embed)
    ...
    async def hug(self, interaction: discord.Interaction, user: discord.Member):
        embed = make_embed(interaction.user.id, hug_links, target=user,
    ...
    async def lick(self, interaction: discord.Interaction, user: discord.Member):
        ...
        embed = make_embed(interaction.user.id, lick_links, target=user, self_tag_msg=self_msg, other_tag_msg=other_msg,
                           img_on_self_tag=False)
        await interaction.response.send_message(embed=embed)
    ...
    async def pat(self, interaction: discord.Interaction, user: discord.Member):
        embed = make_embed(interaction.user.id, pat_links, target=user,
    ...
    async def patback(self, interaction: discord.Interaction, user: discord.Member):
        self_msg = f"{user.mention} patted themselves on the back. Their flexibility is highly impressive and they " \
                   f"deserve a pat on the back already for being this flexible."
        other_msg = f"{user.mention} got a pat on the back."
        embed = make_embed(interaction.user.id, patback_links, target=user, self_tag_msg=self_msg,
                           other_tag_msg=other_msg)
        await interaction.response.send_message(embed=embed)
    ...
    async def pinch(self, interaction: discord.Interaction, user: discord.Member):
        ...
        embed = make_embed(interaction.user.id, pinch_links, target=user, self_tag_msg=self_msg,
                           other_tag_msg=other_msg)
        await interaction.response.send_message(embed=embed)
    ...
    async def pout(self, interaction: discord.Interaction, reason: str | None):
        ...
        embed = make_embed(interaction.user.id, pout_links, target=interaction.user, self_tag_msg=msg)
        await interaction.response.send_message(embed=embed)
    ...
    async def salute(self, interaction: discord.Interaction, user: discord.Member | discord.User | None):
        if user is None:
            ...
            msg = f"{interaction.user.mention} saluted themselves. They must be really proud of what they did. And " \
                  f"I am proud of them too."
        else:
            msg = f"{interaction.user.mention} saluted {user.mention}."
        embed = make_embed(interaction.user.id, salute_links, target=interaction.user, self_tag_msg=msg)
        await interaction.response.send_message(embed=embed)
    ...
    async def slap(self, interaction: discord.Interaction, user: discord.Member):
        embed = make_embed(interaction.user.id, slap_links, target=user,
                           self_tag_msg=f"{user.mention} tried to slap themselves. 'Twas but a gentle caressing.",
                           other_tag_msg=f"{user.mention} got slapped.", img_on_self_tag=False)
        await interaction.response.send_message(embed=embed)
    ...
    async def smug(self, interaction: discord.Interaction, reason: str | None):
        ...
        embed = make_embed(interaction.user.id, smug_links, target=None, no_tag_msg=msg)
        await interaction.response.send_message(embed=embed)
    ...
    async def tickle(self, interaction: discord.Interaction, user: discord.Member):
        ...
        embed = make_embed(interaction.user.id, tickle_links, target=user, self_tag_msg=self_msg,
                           other_tag_msg=other_msg)
        await interaction.response.send_message(embed=embed)
    ...
    async def wave(self, interaction: discord.Interaction, user: discord.Member):
        ...
        embed = make_embed(interaction.user.id, wave_links, target=user, self_tag_msg=self_msg,
                           other_tag_msg=other_msg)
        await interaction.response.send_message(embed=embed)
...
def make_embed(invoker_id: int, links: list[str] | None = None, /,
               target: discord.User | discord.Member | None = None,
               self_tag_msg: str = "", other_tag_msg: str = "", no_tag_msg: str = "",
               img_on_self_tag: bool = True) -> discord.Embed:
