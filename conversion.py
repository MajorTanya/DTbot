...
class Conversion():
    ...
    @commands.command(hidden=True,
                      ...
                      brief='°C    > K',
                      aliases=['ctok'])
    async def ________ck(self, number):
    ...
    @commands.command(hidden=True,
                      ...
                      brief='K    > °C',
                      aliases=['ktoc'])
    async def ________kc(self, number):
        ck_value = round(float(number) - 273.15, 2)
    ...
    @commands.command(hidden=True,
                      ...
                      brief='K    > °F',
                      aliases=['ktof'])
    async def _______kf(self, number):
    ...
    @commands.command(hidden=True,
                      ...
                      brief='°F    > K',
                      aliases=['ftok'])
    async def _______fk(self, number):
    ...
    @commands.command(name='cf',
                      ...
                      brief='°C    > °F',
                      aliases=['ctof'])
    async def ______cf(self, number):
    ...
    @commands.command(name='fc',
                      ...
                      brief='°F    > °C',
                      aliases=['ftoc'])
    async def ______fc(self, number):
    ...
    @commands.command(name='cmin',
                      ...
                      brief='cm    > in',
                      aliases=['cmtoin'])
    async def _____cmin(self, number):
    ...
    @commands.command(name='incm',
                      ...
                      brief='in    > cm',
                      aliases=['intocm'])
    async def _____incm(self, number):
    ...
    @commands.command(name='kglbs',
                      ...
                      brief='kg    > lbs',
                      aliases=['kgtolbs'])
    async def ___kglbs(self, number):
    ...
    @commands.command(name='lbskg',
                      ...
                      brief='lbs   > kg',
                      aliases=['lbstokg'])
    async def ___lbskg(self, number):
    ...
    @commands.command(name='ftinm',
                      ...
                      brief='ft in > m',
                      aliases=['ftintom'])
    async def _ftinm(self, feet, inches):
    ...
    @commands.command(description='Convert from Milliliters to US Fluid Ounces\n\nUsage:\n+mlfloz 10',
                      brief='ml    > floz')
    async def mlfloz(self, number):
        floz_value = round(float(number) * 0.033814, 2)
        await self.bot.say(str(floz_value) + ' floz')
