...
class Conversion(commands.Cog):
    ...
    async def cf(self, interaction: discord.Interaction[DTbot], celsius: float):
    ...
    async def fc(self, interaction: discord.Interaction[DTbot], fahrenheit: float):
    ...
    @app_commands.describe(centimeters="The value in Centimeters")
    async def cmft(self, interaction: discord.Interaction[DTbot], centimeters: float):
    ...
    async def ftcm(self, interaction: discord.Interaction[DTbot], feet: float):
    ...
    async def ftm(self, interaction: discord.Interaction[DTbot], feet: float):
    ...
    async def mft(self, interaction: discord.Interaction[DTbot], meters: float):
    ...
    async def ftinm(self, interaction: discord.Interaction[DTbot], feet: float, inches: float):
    ...
    @app_commands.describe(meters="The value in Meters")
    async def mftin(self, interaction: discord.Interaction[DTbot], meters: float):
    ...
    async def kmmi(self, interaction: discord.Interaction[DTbot], kilometers: float):
    ...
    async def mikm(self, interaction: discord.Interaction[DTbot], miles: float):
    ...
    async def kglbs(self, interaction: discord.Interaction[DTbot], kilograms: float):
    ...
    async def lbskg(self, interaction: discord.Interaction[DTbot], pounds: float):
    ...
    async def flozml(self, interaction: discord.Interaction[DTbot], floz: float):
    ...
    async def mlfloz(self, interaction: discord.Interaction[DTbot], milliliters: float):
    ...
    async def gall(self, interaction: discord.Interaction[DTbot], gallons: float):
    ...
    async def lgal(self, interaction: discord.Interaction[DTbot], liters: float):
