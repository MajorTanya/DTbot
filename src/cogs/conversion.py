...
class Conversion(commands.Cog):
    ...
    async def cf(self, interaction: discord.Interaction[DTbot], celsius: float) -> None:
    ...
    async def fc(self, interaction: discord.Interaction[DTbot], fahrenheit: float) -> None:
    ...
    async def cmin(self, interaction: discord.Interaction[DTbot], centimeters: float) -> None:
    ...
    async def incm(self, interaction: discord.Interaction[DTbot], inches: float) -> None:
    ...
    @app_commands.describe(centimeters="The value in Centimeters")
    async def cmft(self, interaction: discord.Interaction[DTbot], centimeters: float) -> None:
    ...
    async def ftcm(self, interaction: discord.Interaction[DTbot], feet: float) -> None:
    ...
    async def ftm(self, interaction: discord.Interaction[DTbot], feet: float) -> None:
    ...
    async def mft(self, interaction: discord.Interaction[DTbot], meters: float) -> None:
    ...
    async def ftinm(self, interaction: discord.Interaction[DTbot], feet: float, inches: float) -> None:
    ...
    @app_commands.describe(meters="The value in Meters")
    async def mftin(self, interaction: discord.Interaction[DTbot], meters: float) -> None:
    ...
    async def kmmi(self, interaction: discord.Interaction[DTbot], kilometers: float) -> None:
    ...
    async def mikm(self, interaction: discord.Interaction[DTbot], miles: float) -> None:
    ...
    async def kglbs(self, interaction: discord.Interaction[DTbot], kilograms: float) -> None:
    ...
    async def lbskg(self, interaction: discord.Interaction[DTbot], pounds: float) -> None:
    ...
    async def flozml(self, interaction: discord.Interaction[DTbot], floz: float) -> None:
    ...
    async def mlfloz(self, interaction: discord.Interaction[DTbot], milliliters: float) -> None:
    ...
    async def gall(self, interaction: discord.Interaction[DTbot], gallons: float) -> None:
    ...
    async def lgal(self, interaction: discord.Interaction[DTbot], liters: float) -> None:
